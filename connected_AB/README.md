...
|------------------------------|----------|--------------|---------------------|
| Building A Power             | 8.0 kW   | 10.3 kW      | **+28.1%**          |
| Building A Comfort Violations| 23.7 °C·h| 5.6 °C·h     | **-76.3%**          |
| Building B SOC               | 0.6      | 0.3          | -0.3 (discharging)  |
| Feeder Utilization           | 40%      | 45%          | **+5%**             |
